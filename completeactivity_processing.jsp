<%-- Document : completeactivity_processing Created on : 04 6, 23, 10:12:24 PM
    ...
    <div class="asset_form">
      <form action="index.html" class="form_class">
        <jsp:useBean
          ...
          scope="session"
        />
        <% //Receive the values from completeassetactivity.jsp B.asset_id =
        Integer.parseInt(request.getParameter("assetactivity")); int status =
        B.complete_assetactivity(); if(status == 1){ %>
