<%-- 
    Document   : recordact
    Created on : 04 10, 23, 2:00:19 AM
    Author     : ccslearner
--%>
      ...
      <div class="formEdit">
        <form action="record_processing.jsp" class="form_class">
          ...
          <div class="col1" id="second">
            ...
            <input type="submit" value="Submit" class="btn-submit" id="record_submit" />
          </div>
        </form>
      </div>
    </div>
